...
# mapreader game (no module)
#python main.py --game_name=mapreader --num_variations 250 --train_or_eval=train-gen --set=train --traindataSavePrefix=t5goldout
#python main.py --game_name=mapreader --num_variations 250 --train_or_eval=train-gen --set=dev --traindataSavePrefix=t5goldout

# mapreader game + navigation module
#python main.py --game_name=mapreader --num_variations 250 --train_or_eval=train-gen --set=train --useSymbolicModules=navigation --traindataSavePrefix=t5goldout-withnavmodule
#python main.py --game_name=mapreader --num_variations 250 --train_or_eval=train-gen --set=dev --useSymbolicModules=navigation --traindataSavePrefix=t5goldout-withnavmodule

# mapreader game (random)
python main.py --game_name=mapreader-random --num_variations 100 --train_or_eval=train-gen --set=train --traindataSavePrefix=t5goldout
python main.py --game_name=mapreader-random --num_variations 100 --train_or_eval=train-gen --set=dev --traindataSavePrefix=t5goldout

# mapreader game (random) + navigation module
#python main.py --game_name=mapreader-random --num_variations 100 --train_or_eval=train-gen --set=train --useSymbolicModules=navigation --traindataSavePrefix=t5goldout-withnavmodule
#python main.py --game_name=mapreader-random --num_variations 100 --train_or_eval=train-gen --set=dev --useSymbolicModules=navigation --traindataSavePrefix=t5goldout-withnavmodule
